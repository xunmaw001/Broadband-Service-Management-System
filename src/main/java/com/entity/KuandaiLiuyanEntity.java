...
public class KuandaiLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public KuandaiLiuyanEntity() {

	}

	public KuandaiLiuyanEntity(T t) {
		try {
    ...
    @TableField(value = "kuandai_liuyan_text")

    private String kuandaiLiuyanText;
	 ...
	 * 获取：留言内容
	 */
    public String getKuandaiLiuyanText() {
        return kuandaiLiuyanText;
    }
    /**
	 * 设置：留言内容
	 */

    public void setKuandaiLiuyanText(String kuandaiLiuyanText) {
        this.kuandaiLiuyanText = kuandaiLiuyanText;
    }
    /**
	 * 获取：留言时间
	 */
    ...
    public String toString() {
        return "KuandaiLiuyan{" +
            ", id=" + id +
            ", kuandaiId=" + kuandaiId +
            ", yonghuId=" + yonghuId +
            ", kuandaiLiuyanText=" + kuandaiLiuyanText +
