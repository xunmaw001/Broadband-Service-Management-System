...
public class BaoxiuCommentbackEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public BaoxiuCommentbackEntity() {

	}

	public BaoxiuCommentbackEntity(T t) {
		try {
    ...
    @TableField(value = "baoxiu_commentback_text")
    ...
    public String toString() {
        return "BaoxiuCommentback{" +
            ", id=" + id +
            ", baoxiuId=" + baoxiuId +
            ", yonghuId=" + yonghuId +
            ", baoxiuCommentbackText=" + baoxiuCommentbackText +
