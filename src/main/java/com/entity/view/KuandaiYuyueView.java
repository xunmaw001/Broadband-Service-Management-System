...
public class KuandaiYuyueView extends KuandaiYuyueEntity implements Serializable {
	...
	*/
	...
	private String kuandaiYuyueYesnoValue;
	...
	public KuandaiYuyueView() {

	}

	public KuandaiYuyueView(KuandaiYuyueEntity kuandaiYuyueEntity) {
		try {
			BeanUtils.copyProperties(this, kuandaiYuyueEntity);
	...
	* 获取： 报名状态的值
	*/
	public String getKuandaiYuyueYesnoValue() {
		return kuandaiYuyueYesnoValue;
	}
	/**
	* 设置： 报名状态的值
	*/
	public void setKuandaiYuyueYesnoValue(String kuandaiYuyueYesnoValue) {
		this.kuandaiYuyueYesnoValue = kuandaiYuyueYesnoValue;
	}
	...
	public String toString() {
		return "KuandaiYuyueView{" +
			", kuandaiYuyueYesnoValue=" + kuandaiYuyueYesnoValue +
