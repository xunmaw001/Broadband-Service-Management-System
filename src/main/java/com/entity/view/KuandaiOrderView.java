...
public class KuandaiOrderView extends KuandaiOrderEntity implements Serializable {
	...
	*/
	...
	private String kuandaiOrderValue;
	...
	public KuandaiOrderView() {

	}

	public KuandaiOrderView(KuandaiOrderEntity kuandaiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, kuandaiOrderEntity);
	...
	* 获取： 订单类型的值
	*/
	public String getKuandaiOrderValue() {
		return kuandaiOrderValue;
	}
	/**
	* 设置： 订单类型的值
	*/
	public void setKuandaiOrderValue(String kuandaiOrderValue) {
		this.kuandaiOrderValue = kuandaiOrderValue;
	}
	...
	public String toString() {
		return "KuandaiOrderView{" +
			", kuandaiOrderValue=" + kuandaiOrderValue +
