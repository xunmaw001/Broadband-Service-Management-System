...
public class KuandaiCollectionView extends KuandaiCollectionEntity implements Serializable {
	...
	*/
	...
	private String kuandaiCollectionValue;
	...
	public KuandaiCollectionView() {

	}

	public KuandaiCollectionView(KuandaiCollectionEntity kuandaiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, kuandaiCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getKuandaiCollectionValue() {
		return kuandaiCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setKuandaiCollectionValue(String kuandaiCollectionValue) {
		this.kuandaiCollectionValue = kuandaiCollectionValue;
	}
	...
	public String toString() {
		return "KuandaiCollectionView{" +
			", kuandaiCollectionValue=" + kuandaiCollectionValue +
