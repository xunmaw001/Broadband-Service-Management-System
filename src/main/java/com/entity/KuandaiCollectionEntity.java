...
public class KuandaiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public KuandaiCollectionEntity() {

	}

	public KuandaiCollectionEntity(T t) {
		try {
    ...
    @TableField(value = "kuandai_collection_types")
    ...
    public String toString() {
        return "KuandaiCollection{" +
            ", id=" + id +
            ", kuandaiId=" + kuandaiId +
            ", yonghuId=" + yonghuId +
            ", kuandaiCollectionTypes=" + kuandaiCollectionTypes +
