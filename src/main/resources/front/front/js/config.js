...
var centerMenu = [
    ...
    ,{
        name: '报修',
        url: '../baoxiu/list.html'
    }
    ,{
        name: '宽带缴费',
        url: '../feiyong/list.html'
    }
    ,{
        name: '宽带收藏',
        url: '../kuandaiCollection/list.html'
    }
    ,{
        name: '宽带开户',
        url: '../kuandaiOrder/list.html'
    }
    ,{
        name: '宽带预约安装',
        url: '../kuandaiYuyue/list.html'
    }
    ,{
        name: '迁移申请',
        url: '../qianyiYuyue/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '宽带',
        url: './pages/kuandai/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/kuandaiyewuguanlixitong/admin/dist/index.html#/login";
