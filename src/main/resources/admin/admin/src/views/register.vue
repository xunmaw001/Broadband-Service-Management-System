    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">宽带业务管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="业务人员姓名" class="input" v-if="tableName=='yewurenyuan'">
                            <el-input v-model="ruleForm.yewurenyuanName" autocomplete="off" placeholder="业务人员姓名"  />
                        </el-form-item>
                        <el-form-item label="业务人员手机号" class="input" v-if="tableName=='yewurenyuan'">
                            <el-input v-model="ruleForm.yewurenyuanPhone" autocomplete="off" placeholder="业务人员手机号"  />
                        </el-form-item>
                        <el-form-item label="业务人员身份证号" class="input" v-if="tableName=='yewurenyuan'">
                            <el-input v-model="ruleForm.yewurenyuanIdNumber" autocomplete="off" placeholder="业务人员身份证号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="yewurenyuanPhotoFlag">
                            </el-form-item>
                            <el-form-item label="业务人员头像" class="input" v-if="tableName=='yewurenyuan'">
                                    <file-upload
                                        tip="点击上传业务人员头像"
                                        action="file/upload"
                                        :limit="1"
                                        :multiple="true"
                                        :fileUrls="ruleForm.yewurenyuanPhoto?$base.url+ruleForm.yewurenyuanPhoto:''"
                                        @change="yewurenyuanPhotoUploadChange"
                                    ></file-upload>
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="余额" class="input" v-if="tableName=='yewurenyuan'">
                                <el-input v-model="ruleForm.newMoney" autocomplete="off" placeholder="余额"  />
                           </el-form-item>
                        -->
                        <el-form-item label="业务人员邮箱" class="input" v-if="tableName=='yewurenyuan'">
                            <el-input v-model="ruleForm.yewurenyuanEmail" autocomplete="off" placeholder="业务人员邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='yewurenyuan'">
    ...
    export default {
        data() {
            return {
                ...
                rules: {},
                sexTypesOptions : [],
                yewurenyuanPhotoFlag:false,//用于刷新文件上传
        ...
        methods: {
            ...
            yewurenyuanPhotoUploadChange(fileUrls) {
               this.ruleForm.yewurenyuanPhoto = fileUrls;
                if(this.yewurenyuanPhotoFlag){
                    this.yewurenyuanPhotoFlag=false;
                }else{
                    this.yewurenyuanPhotoFlag=true;
                }
            },
            ...
            login() {
                            ...
                            if((!this.ruleForm.yewurenyuanName)&& 'yewurenyuan'==this.tableName){
                                this.$message.error('业务人员姓名不能为空');
                                return
                            }
                             if('yewurenyuan' == this.tableName && this.ruleForm.yewurenyuanPhone&&(!this.$validate.isMobile(this.ruleForm.yewurenyuanPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.yewurenyuanIdNumber)&& 'yewurenyuan'==this.tableName){
                                this.$message.error('业务人员身份证号不能为空');
                                return
                            }
                            // yewurenyuan 中的 业务人员头像 判空处理
                            // if('yewurenyuan' == this.tableName && (this.ruleForm.yewurenyuanPhoto== null ||this.ruleForm.yewurenyuanPhoto== "")){
                            //     this.$message.error("业务人员头像不能为空");
                            //     return
                            // }
                            // yewurenyuan 中的 余额 判空处理
                            // if('yewurenyuan' == this.tableName && (this.ruleForm.newMoney== null ||this.ruleForm.newMoney== "")){
                            //     this.$message.error("余额不能为空");
                            //     return
                            // }
                            if('yewurenyuan' == this.tableName && this.ruleForm.yewurenyuanEmail&&(!this.$validate.isEmail(this.ruleForm.yewurenyuanEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                            // yewurenyuan 中的 创建时间 判空处理
                            // if('yewurenyuan' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
...
<style lang="scss" scoped>
	...
	.container {
        ...
        background-image: url(/kuandaiyewuguanlixitong/img/back-img-bg.jpg);
