    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名唯一编号" prop="qianyiYuyueUuidNumber">
                       <el-input v-model="ruleForm.qianyiYuyueUuidNumber"
                                 placeholder="报名唯一编号" clearable  :readonly="ro.qianyiYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名唯一编号" prop="qianyiYuyueUuidNumber">
                           <el-input v-model="ruleForm.qianyiYuyueUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="理由" prop="qianyiYuyueText">
                        <el-input type="textarea"  :readonly="ro.qianyiYuyueText" v-model="ruleForm.qianyiYuyueText" placeholder="理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.qianyiYuyueText" label="理由" prop="qianyiYuyueText">
                            <span v-html="ruleForm.qianyiYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.qianyiYuyueYesnoTypes" label="报名状态" prop="qianyiYuyueYesnoTypes">
                        <el-input v-model="ruleForm.qianyiYuyueYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.qianyiYuyueYesnoText" label="审核回复" prop="qianyiYuyueYesnoText">
                        <span v-html="ruleForm.qianyiYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.qianyiYuyueShenheTime" label="审核时间" prop="qianyiYuyueShenheTime">
                        <span v-html="ruleForm.qianyiYuyueShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    qianyiYuyueUuidNumber: false,
                    yonghuId: false,
                    qianyiYuyueText: false,
                    qianyiYuyueYesnoTypes: false,
                    qianyiYuyueYesnoText: false,
                    qianyiYuyueShenheTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    qianyiYuyueUuidNumber: new Date().getTime(),
                    yonghuId: '',
                    qianyiYuyueText: '',
                    qianyiYuyueYesnoTypes: '',
                    qianyiYuyueYesnoText: '',
                    qianyiYuyueShenheTime: '',
                    insertTime: '',
                },
                qianyiYuyueYesnoTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   qianyiYuyueUuidNumber: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=qianyi_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.qianyiYuyueYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`qianyiYuyue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.qianyiYuyueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
